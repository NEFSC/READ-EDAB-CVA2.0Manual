...
Fisheries dependent data is data collected by commercial and recreational fishers. In the United States, commercial fisheries data is collected by fisheries observers in the [National Observer Program](https://www.fisheries.noaa.gov/national/fisheries-observers/national-observer-program), [Gillnet Observer Program](https://www.fisheries.noaa.gov/southeast/fisheries-observers/southeast-gillnet-observer-program
), and [Pelagic Observer Program](https://www.fisheries.noaa.gov/southeast/fisheries-observers/southeast-pelagic-observer-program
). These are trained individuals who accompany fishing boats on their trips to collect data on the species caught. Data from recreational fisheries is collected using post-effort in person or phone surveys at different docks via the Southeast Fisheries Science Center's Logbook and the National Marine Fisheries Services' [Large Pelagics Survey](https://www.fisheries.noaa.gov/recreational-fishing-data/large-pelagics-survey-glance
) programs. 
...
### For the CVA2.0
We are using the hindcast timeseries from 1993-2023 from the MOM6 for the Northwest Atlantic to build the species distribution models. We will then project these models into the future using the decadal and long-term projections from the MOM6. 
